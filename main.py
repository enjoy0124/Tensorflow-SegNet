...
tf.app.flags.DEFINE_string('log_dir', "./tensorflow/logs", """ dir to store ckpt """)
tf.app.flags.DEFINE_string('image_dir', "./dataset/CamVid/train.txt", """ path to CamVid image """)
tf.app.flags.DEFINE_string('test_dir', "./dataset/CamVid/test.txt", """ path to CamVid test image """)
tf.app.flags.DEFINE_string('val_dir', "./dataset/CamVid/val.txt", """ path to CamVid val image """)
